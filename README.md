...
- [ ] Escribe un script que realice al menos 5 tareas de Ciberseguridad y cumpla los siguientes tópicos: 
    ...
    - [ ] Usar al menos un módulo de Python que no hayamos visto en clase y que esté relacionado con Ciberseguridad, desarrollo de una rutina de código que haga alguna función que pueda ayudarnos con seguridad o uso de un módulo que con su aplicación podamos realizar alguna tarea de ciberseguridad ( **Obligatorio** )
    - [ ] Que se genere reportes, en al menos una de las tareas de ciberseguridad, en formato html, xlx(x) o txt. Directamente el uso del logging no cuenta, a menos que además del logging regular implementen otro archibo para generar el reporte ( **Obligatorio** )
    - [ ] El script debe estar integrado por al menos 3 módulos ( **Obligatorio** ): 
